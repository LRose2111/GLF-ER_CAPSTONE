            ...
            return (
                <div className = "article-core-contain" key = {index}>
                    ...
                    <div className="desc-contain-art">
                        <div><b className="red-news">Description:</b><medium className="news-general-font"> {article.description}</medium> </div>
                    </div>
                    <div>
                        <div><b className="red-news">Source:</b><medium className="news-general-font"> {article.source.name}</medium> </div>
                    </div>
                </div>
            )
            })}
